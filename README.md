...
Расширить LLM_PROVIDER режимами yandex, gigachat, mock.

yandex — YandexGPT API (через Yandex Cloud / SDK).[web:155][web:156][web:161]

gigachat — GigaChat API от Сбера.[web:124][web:162]
...
Простейшая статистика /admin‑командой (кол‑во запросов, топ‑темы).

Деплой на сервер

Dockerfile + docker-compose.yml.

Деплой на VPS / PaaS, запуск как systemd‑сервис или контейнер.[web:160][web:163]

Вариант деплоя целиком в РФ с YandexGPT/GigaChat для работы без VPN.[web:155][web:156][web:161][web:124][web:162]
